...
<p>
Shipping Date:<fmt:formatDate type="date" value="${now}"/></p>
</div></div>
...
<button class="btn btn-default" name="_eventId_backToCollectShippingAddress">Back</button>
